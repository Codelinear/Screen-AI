...
const TestLoading: NextPage = () => {
  return (
    <div className="w-full relative bg-whitesmoke overflow-hidden flex flex-col items-start justify-start pt-[4.25rem] px-[7.5rem] pb-[30.875rem] box-border gap-[7.125rem] leading-[normal] tracking-[normal] text-left text-[2.294rem] text-gray font-graphik lg:pl-[3.75rem] lg:pr-[3.75rem] lg:box-border mq450:gap-[1.75rem] mq750:gap-[3.563rem] mq750:pl-[1.875rem] mq750:pr-[1.875rem] mq750:box-border">
      ...
      <div className="w-[63.638rem] flex flex-col items-start justify-start gap-[7.687rem] max-w-full text-[5.125rem] text-darkslategray mq450:gap-[0.938rem] mq750:gap-[1.938rem] mq1050:gap-[3.813rem]">
        <h1 className="m-0 self-stretch h-[11.25rem] relative text-inherit tracking-[-0.04em] font-normal font-inherit inline-block mq450:text-[1.563rem] mq1050:text-[2.563rem]">
          Give us a moment while we check if you are the right fit.
        </h1>
        <div className="w-[60.75rem] h-[2.438rem] relative rounded-6xl [background:linear-gradient(90deg,_#ebdfff,_#f5afea)] overflow-hidden shrink-0 max-w-full">
