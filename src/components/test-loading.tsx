const TestLoading = ({ progress }: { progress: number }) => {
  return (
    <div className="w-full bg-whitesmoke overflow-hidden flex flex-col items-start justify-start h-md:absolute h-md:top-[10%] pt-32 pl-6 md:pb-0 pb-10 sm:pl-14 xl:pl-28 box-border gap-[3.2rem] h-lg:gap-[7.125rem] text-left text-[2.294rem]">
